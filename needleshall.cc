...
NeedlesHall::NeedlesHall(const std::string& name, int position, std::mt19937& rng)
    ...
    effects.push_back(std::make_unique<MoneyEffect>(-200));
    effects.push_back(std::make_unique<MoneyEffect>(-100));
    effects.push_back(std::make_unique<MoneyEffect>(-50));
    effects.push_back(std::make_unique<MoneyEffect>(25));
    effects.push_back(std::make_unique<MoneyEffect>(50));
    effects.push_back(std::make_unique<MoneyEffect>(100));
    effects.push_back(std::make_unique<MoneyEffect>(200));
}

NeedlesHall::~NeedlesHall() = default;
